...
function submitEdit() {
    ...
    var data = JSON.stringify({ test_paper_id: test_paper_id, title: title, duration: duration, questions: questions, delete_questions: delete_questions });
    console.log(data)
    $.ajax({
        type: "PUT",
        url: "/teacher/test_paper/",
